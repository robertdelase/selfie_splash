...
class ProfileMemes extends StatelessWidget {
  ProfileMemes({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        elevation: 0.2,
        titleSpacing: 0,
        title: Text('Memes', style: TextStyle(color: Colors.black, fontSize: 22, fontWeight: FontWeight.w600),),
        leading: PopContext(),
      ),
	    //layout for Memes section of user's profile gallery
      body: Container(
...
//layout of single image/video item in an uploaded content in gallery

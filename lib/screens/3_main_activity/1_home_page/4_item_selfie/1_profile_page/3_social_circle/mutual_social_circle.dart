...
class MutualSocialCircle extends StatefulWidget {
  @override
  MutualSocialCircleState createState() => MutualSocialCircleState();
}

class MutualSocialCircleState extends State<MutualSocialCircle> {
          ...
          body: TabBarView(
              children: [
                ...
                SingleChildScrollView(
                  child: Column(
                    children: [
                      SearchInput(hint: 'mutual', changed: (value){},),
                      Container(
                        child: ListView(
                          shrinkWrap: true,

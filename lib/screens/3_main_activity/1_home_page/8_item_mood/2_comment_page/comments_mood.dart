...
import '../../9_comment_reacts_tags/reacts.dart';

class CommentsMood extends StatelessWidget {
  const CommentsMood({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        elevation: 0.5,
        titleSpacing: 0,
	      //displays name of poster with corresponding item (Mood)
        title: Text('Alice Stark\'s mood', style: kOnboardTextBig.copyWith(color: Colors.black,
...
class CommentMoodItem extends StatelessWidget {
  const CommentMoodItem({
    Key? key,
  }) : super(key: key);
          ...
          child: SingleChildScrollView(
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 10,),
                Container(color: Colors.grey.shade600, width: double.infinity,height: 1,),
                Container(
                  height: 55,
                  child: Row(
                    crossAxisAlignment: CrossAxisAlignment.center,

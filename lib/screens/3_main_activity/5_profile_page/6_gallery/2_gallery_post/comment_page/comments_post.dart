...
import '../../../../1_home_page/9_comment_reacts_tags/reacts.dart';
import '../../../../1_home_page/9_comment_reacts_tags/tags.dart';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        elevation: 0.5,
        titleSpacing: 0,
	    //displays name of poster with corresponding item (Post)
        title: Text('Alice Stark\'s post', style: kOnboardTextBig.copyWith(color: Colors.black,
          ...
          child: SingleChildScrollView(
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 10,),
                //displays image/video of post uploaded. Multiple media should be viewed with swiping & indicator dots like on IG

...
class AdsPageOld extends StatefulWidget {
  const AdsPageOld({Key? key}) : super(key: key);

  @override
  State<AdsPageOld> createState() => _AdsPageOldState();
}

class _AdsPageOldState extends State<AdsPageOld> with SingleTickerProviderStateMixin {

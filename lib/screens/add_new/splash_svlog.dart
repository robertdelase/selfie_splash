...
class SplashSVlog extends StatelessWidget {
  const SplashSVlog({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        elevation: 0.2,
        titleSpacing: 0,
        title: Text('New SVlog', style: kOnboardTextBig.copyWith(color: Colors.black, fontSize: 25, fontWeight: FontWeight.w600),),
        toolbarHeight: 70,
      ),

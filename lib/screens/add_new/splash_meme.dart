...
class SplashMeme extends StatelessWidget {
  const SplashMeme({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        elevation: 0.2,
        titleSpacing: 0,
        title: Text('New Meme', style: kOnboardTextBig.copyWith(color: Colors.black, fontSize: 25, fontWeight: FontWeight.w600),),
        toolbarHeight: 70,
      ),
      ...
      body: Padding(
        ...
        child: SingleChildScrollView(
	      ...
	      //for displaying selected image/video from phone gallery or camera
              ...
              SizedBox(height: 25,),
	      //for inputing caption text for the Meme item
              InputBoxes(title: 'Add Caption', hint: 'caption', changed: (value){},),
              SizedBox(height: 25,),
	      //for inputing hashtag(s) for the Meme item
              InputBoxes(title: 'Add MemeTag (i.e. #happymeme #smilingmeme)', hint: 'hashtag', changed: (value){},),
              SizedBox(height: 25,),
	      //for inputing and selecting names of friends/followers to tag for the Meme item
              InputBoxes(title: 'Tag People', hint: 'people you want to tag', changed: (value){},),
              SizedBox(height: 25,),
	      //for inputing & selecting location for the Meme item
